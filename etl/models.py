...
class Animal(models.Model):
    ...
    born_at_raw = models.CharField(
        max_length=100, null=True, blank=True, help_text="Original born_at string"
    )

    friends = models.JSONField(default=list, help_text="Transformed friends array")
    born_at = models.DateTimeField(
        null=True, blank=True, help_text="Transformed ISO8601 UTC timestamp"
    )
